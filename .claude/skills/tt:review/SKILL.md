...
!`NO_COLOR=1 ./dist/tt review gather $ARGUMENTS 2>&1`
...
```
./dist/tt review save --title "<generated or user-provided title>" --audience <audience> --content "<the approved review content>" --period-start <ms> --period-end <ms> --total-ms <ms>
```
