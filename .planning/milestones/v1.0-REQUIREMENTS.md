...
- [~] **PROJ-02**: User can override project mapping via config file or `tt alias add <dir> <slug>` *(config file works; CLI command deferred to v2)*
- [~] **PROJ-03**: User can set hourly rate per project *(via config file; CLI command deferred to v2)*
- [x] **PROJ-04**: User can list all known projects with `tt projects` (showing this-week totals)
- [~] **PROJ-05**: Project config supports client name, display name, slug, rate, and currency *(schema complete; CLI management deferred to v2)*
...
| PROJ-02 | Phase 1 | Partial (config file only, CLI deferred to v2) |
| PROJ-03 | Phase 1 | Partial (config file only, CLI deferred to v2) |
| PROJ-04 | Phase 3 | Complete |
| PROJ-05 | Phase 1 | Partial (schema complete, CLI management deferred to v2) |
...
| CLCD-01 | Phase 5 | Complete |
| CLCD-02 | Phase 5 | Complete |
| CLCD-03 | Phase 5 | Complete |
| CLCD-04 | Phase 5 | Complete |
| CLCD-05 | Phase 5 | Complete |
| CLCD-06 | Phase 5 | Complete |
| CLCD-07 | Phase 5 | Complete |

**Coverage:**
- v1 requirements: 50 total
- Complete: 47
- Partial (config-only, CLI deferred to v2): 3 (PROJ-02, PROJ-03, PROJ-05)
- Unmapped: 0

---
*Requirements defined: 2026-02-27*
*Last updated: 2026-02-28 after milestone audit — all requirements verified against code*
